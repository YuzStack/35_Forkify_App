...
})({"gOUgA":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 65431;
...
const controllRecipes = async function() {
    try {
        ...
        console.error(err);
        (0, _recipeViewJsDefault.default).renderError('Something went wrong! Please try again :)');
    }
};
const controlSearchResults = async function() {
    try {
        ...
        (0, _resultsViewJsDefault.default).renderError('Something went wrong! Please try again :)');
    }
};
...
const init = function() {
    ...
    (0, _recipeViewJsDefault.default).addHandlerBookmark(controlAAddBookmark);
...
},{"core-js/modules/web.immediate.js":"bzsBv","./model.js":"3QBkH","./views/recipeView.js":"3wx5k","./views/searchView.js":"kbE4Z","./views/resultsView.js":"kBQ4r","./views/paginationView.js":"7NIiB","./views/bookmarksView.js":"1qGeA","./views/addRecipeView.js":"8AWnP","./config.js":"2hPh4","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
const updateServings = function(newServings) {
    ...
    // newQt = oldQt * (newServings / OldServings) // (Formula for getting the new quantity)
    });
...
const API_DOC = 'https://forkify-api.jonas.io';
const API_URL = 'https://forkify-api.jonas.io/api/v2/recipes/';
const TIMEOUT_SEC = 10;
const RES_PER_PAGE = 10;
const API_KEY = '734a12a5-7b3f-459e-b57c-99ac1af4a258';
...
/* // Testing the Fraction.js library
let fracInfo = new Fraction(1.5);
// console.log(fracInfo);
let result = fracInfo.toFraction(true);
// console.log(result);

// Alternatively (chaining)
const value = 1.4;
const resFrac = new Fraction(value).toFraction(true);
// console.log(resFrac); */ class RecipeView extends (0, _viewJsDefault.default) {
...
},{"url:../../img/icons.svg":"fd0vu","./View.js":"jSw21","fraction.js":"md6n5","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fd0vu":[function(require,module,exports,__globalThis) {
...
class AddRecipeView extends (0, _viewJsDefault.default) {
    ...
    addHandlerUpload(handler) {
        this._parentEl.addEventListener('submit', function(e) {
            ...
            // Pass the data object into the handler function
            handler(data);
        });
    }
    _generateMarkup() {}
...
},{"url:../../img/icons.svg":"fd0vu","./View.js":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["gOUgA","7dWZ8"], "7dWZ8", "parcelRequire3a11", {}, "./", "/")

//# sourceMappingURL=35_Forkify_App.4a59a05f.js.map
